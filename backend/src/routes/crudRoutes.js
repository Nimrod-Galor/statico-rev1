...
import { preprocessFormData } from '../middlewares/preprocessFormData.js'
...
// Create Item
router.post('/:contentType', passport.authenticate('jwt', { session: false }), checkPermission('create'), formValidation(), preprocessFormData, createItem)

// Update a Item by ID
router.put('/:contentType/:id', passport.authenticate('jwt', { session: false }), checkPermission('update'), formValidation(), preprocessFormData, updateItem)
